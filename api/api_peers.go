 ...
 * @return Peers
 */
func (a *PeersApiService) PeersGetExecute(r ApiPeersGetRequest) (Peers, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PeersApiService.PeersGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/peers"
...
/*
 * PeersPeerIdGet Retrieve a peer
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 ...
 * @return Peer
 */
func (a *PeersApiService) PeersPeerIdGetExecute(r ApiPeersPeerIdGetRequest) (Peer, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PeersApiService.PeersPeerIdGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/peers/{peerId}"
